    ...
    <main class="container py-5">
        <div class="row">
            <div class="col-12 mb-4">
                <h2 class="filtros-title display-6"><i class="fas fa-search me-2"></i>Consulta de Convocatorias</h2>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="filtros-card p-4 fade-in">
                    <h3 class="filtros-title fs-4"><i class="fas fa-filter me-2"></i>Filtrar Convocatorias</h3>
        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h3 class="filtros-title fs-4 mb-0"><i class="fas fa-th-list me-2"></i>Convocatorias Disponibles</h3>
